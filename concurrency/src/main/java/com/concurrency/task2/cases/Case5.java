...
public class Case5 implements Case {
    ...
    private static final String DESCRIPTION = "byFixedThreadPool(4) with Future with ReadWriteLock";

    private IncrementExample incrementExample;

    public Case5(IncrementExample incrementExample) {
    ...
    public void perform() {
        ...
        for (int i = 0; i < NUMBER_OF_THREADS; i++) {
            tasks.add(() -> {
                ...
                incrementExample.incrementReadWriteLock();
                return threadName;
            });
        }
        try {
